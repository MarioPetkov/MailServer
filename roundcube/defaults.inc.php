...
$config['db_dsnw'] = 'mysql://roundcube:AdminPassword1@#@localhost/roundcubemail';

$config['default_host'] = 'ssl://mail.mariopetkov.com';
...
$config['imap_conn_options'] = [
  'ssl'         => [
     'verify_peer'  => true,
     'verify_depth' => 3,
     'cafile'       => '/etc/ssl/certs/mailserver.pem',
   ],
 ];
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %t = domain.tld
$config['mail_domain'] = 'mail.mariopetkov.com';
